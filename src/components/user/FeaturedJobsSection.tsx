...
const FeaturedJobsSection = () => {
  ...
  const filteredJobs = activeFilter === 'All' ? jobData : jobData.filter(job => job.jobType === activeFilter);
  
  const handleApplyClick = (job: Job) => {
    if (isLoggedIn) {
      console.log(`User is applying for the job: "${job.title}" at "${job.company}"`);
  ...
  const LoginPopup = () => (
    <div className="fixed inset-0 bg-gray-900 bg-opacity-75 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-xl p-8 shadow-2xl max-w-sm w-full text-center">
        ...
        <p className="text-gray-600 mb-6">You need to be logged in to apply for this job. Please log in to continue.</p>
        <button
  ...
  const ApplyConfirmationPopup = () => (
    <div className="fixed inset-0 bg-gray-900 bg-opacity-75 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-xl p-8 shadow-2xl max-w-sm w-full text-center">
        ...
        <p className="text-gray-600 mb-6">Your application for this job has been successfully submitted. Good luck!</p>
        <button
          onClick={handlePopupClose}
          className="w-full px-6 py-3 rounded-lg bg-[#FF7F3F] text-white font-medium hover:bg-[#FF6F2F] transition-colors"
        >
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg">
            <div className="flex items-center space-x-4 mb-6">
              <img src={selectedJob.logo} alt={`${selectedJob.company} logo`} className="rounded-lg w-16 h-16" />
              <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
              <div className="flex items-center text-gray-500">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 mr-2 text-[#FF7F3F]">
  ...
  return (
    <section className="py-16 md:py-24 bg-gray-50 text-gray-800">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="text-3xl md:text-4xl font-bold mb-2">Featured Job Opportunities</h2>
            ...
            >
              <div className="flex justify-between items-center mb-4">
                <div className="flex items-center space-x-4">
                  <img src={job.logo} alt={`${job.company} logo`} className="rounded-lg" />
                  <div>
        ...
        <a href="#" className="inline-flex items-center text-[#FF7F3F] font-bold text-lg hover:underline">
          View All Jobs
