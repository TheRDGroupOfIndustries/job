  ...
  return (
    <section className="relative w-full min-h-screen flex flex-col items-center justify-center text-center text-gray-100 overflow-visible px-4 sm:px-6 md:px-8 lg:px-12">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center max-w-5xl w-full py-20 sm:py-24">
        <h1 className="text-3xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-extrabold leading-tight mb-4 drop-shadow-lg px-2 sm:px-0">
        ...
        <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 mb-10 w-full max-w-sm px-4 sm:max-w-none sm:px-0 justify-center items-center">
          <Link
            href={"/browse-jobs"}
