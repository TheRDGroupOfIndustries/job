    ...
    <section className="relative w-full h-screen flex items-center justify-center text-center text-white overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center p-4 max-w-5xl mx-auto">
        <h1 className="text-4xl md:text-6xl font-extrabold leading-tight mb-4 drop-shadow-lg">
          Find Your <span className="text-[#FF7F3F]">Dream Career</span> Today
        </h1>
        ...
        <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 mb-10">
          <button className="px-8 py-4 bg-[#FF7F3F] text-white font-semibold rounded-full shadow-lg hover:bg-orange-600 transition-colors duration-200 flex items-center space-x-2">
            <Search size={20} />
            <span>Browse Jobs</span>
          </button>
          <button className="px-8 py-4 bg-white text-gray-800 font-semibold rounded-full shadow-lg hover:bg-gray-100 transition-colors duration-200 flex items-center space-x-2">
            <Briefcase size={20} />
