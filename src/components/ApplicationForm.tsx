...
  // Watch the rating field to display stars dynamically
  const ratingWatch = watch("ratings", 3);
  const [isSubmitting, setIsSubmitting] = useState(false);

  // 2. Define the submit handler with the TypeScript interface
  const onSubmit: SubmitHandler<IFormInput> = (data) => {
    setIsSubmitting(true);
    console.log("Form Data Submitted:", data);

    // If you were sending this to a real API, you'd process it here:
