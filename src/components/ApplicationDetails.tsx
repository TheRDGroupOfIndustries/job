...
import { ArrowDownToLine, ChevronLeft, Download, FileText, MapPin, Star, Code } from "lucide-react"; // Imported MapPin, Star, Code
...
          />
        ))}
        <span className="ml-2 font-semibold text-gray-800">{rating.toFixed(1)} / 5</span>
      </div>
    );
  };
...
                  {application.image ? (
                    <img src={application.image} alt={application.appliedBy.name} className="w-full h-full object-cover rounded-full" />
                  ) : (
...
                  <div>
                    <h3 className="font-semibold text-gray-800 mb-1 flex items-center">
                      <Star size={16} className="mr-2 text-yellow-500"/> Self-Rating
                    </h3>
                    {renderRatingStars(application.ratings || 0)}
                  </div>
                </div>
                {/* NEW FIELD: Skills */}
...
                      <Code size={16} className="mr-2 text-blue-500"/> Skills
                    </h3>
