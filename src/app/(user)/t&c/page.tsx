      ...
      <div className="container mx-auto px-4 pt-20 pb-8 max-w-3xl">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            Welcome to Alpran Software Pvt Ltd. These Terms and Conditions
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            We provide IT training, recruitment, and HR services. All services
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            ...
            property of Alpran Software Pvt Ltd or its licensors and is
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            To the maximum extent permitted by law, Alpran Software Pvt Ltd
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            jurisdiction of the courts in Varanasi.
          </p>
        </section>
