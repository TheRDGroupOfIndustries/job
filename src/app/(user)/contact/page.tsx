          ...
          <div className="flex flex-wrap lg:flex-nowrap gap-12 justify-center">
            ...
            <div className="w-full lg:w-1/2 p-8 bg-white rounded-lg">
              ...
              <p className="text-gray-600 mb-8">
                Have questions or want to learn more about our services? Reach
                out to us using the contact details below or fill out the form.
              </p>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 space-y-1">
                      <a
                        href="tel:+919839955309"
                        className="block hover:text-orange-500"
                      >
                        +91 98399 55309
                      </a>
                      <a
                        href="tel:+917379715444"
                        className="block hover:text-orange-500"
                      >
                        +91 73797 15444
                      </a>
                      <a
                        href="tel:+918810718650"
                        className="block hover:text-orange-500"
                      >
                        +91 88107 18650
                      </a>
