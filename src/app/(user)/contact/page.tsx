              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <a href="mailto:hr@alpranhrservices.com" className="text-orange-500 hover:underline">hr@alpranhrservices.com</a>
                  </div>
                </div>

                
                <div className="flex items-start">
                  <div className="p-3 bg-orange-100 rounded-full text-orange-500 mr-4 mt-1">
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 space-y-1">
                      <a href="tel:+919839955309" className="block hover:text-orange-500">+91 98399 55309</a>
                      <a href="tel:+917379715444" className="block hover:text-orange-500">+91 73797 15444</a>
                      <a href="tel:+918810718650" className="block hover:text-orange-500">+91 88107 18650</a>
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Alpran Software Pvt Ltd,<br />Mahmoorganj, Varanasi - 221010
                    </p>
                  </div>
                </div>
