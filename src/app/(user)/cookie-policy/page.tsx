      ...
      <main className="max-w-4xl mx-auto px-6 py-16 pt-20 pb-8 min-h-screen bg-white text-gray-900">
        ...
        <section className="mb-8">
          ...
          <p className="leading-relaxed">
            ...
            websites you visit. They help websites remember your actions and
            preferences (such as login, language, and other display preferences)
        ...
        <section className="mb-8">
          ...
          <p className="leading-relaxed mb-4">
            At Alpran HR Services, we use cookies to enhance your user
            experience, analyze site traffic, and provide personalized content
            and ads. These cookies enable us to understand how you interact with
            our services and improve our platform accordingly.
          </p>
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>
              <strong>Performance Cookies:</strong> Help us monitor site
            ...
            <li>
              <strong>Marketing Cookies:</strong> Deliver relevant advertising
        ...
        <section className="mb-8">
          ...
          <p className="leading-relaxed">
            We may allow third-party providers to set cookies on our site for
            analytics and advertising purposes. These providers have their own
        ...
        <section className="mb-8">
          ...
          <p className="leading-relaxed mb-4">
            ...
            usability of some features on our site.
          </p>
          <p>
